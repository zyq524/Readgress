...
namespace Readgress.Data.Helpers
{
    /// <summary>
    /// A maker of Readgress Repositories.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Return the runtime Readgress repository factory functions,
        /// each one is a factory for a repository of a particular type.
        /// </summary>

        private IDictionary<Type, Func<DbContext, object>> GetReadgressFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                   {typeof(IReaderRepository), dbContext => new ReaderRepository(dbContext)},
                   {typeof(IProgressRepository), dbContext => new ProgressRepository(dbContext)},
                   {typeof(IBookmarkRepository), dbContext => new BookmarkRepository(dbContext)},
                };
        }

        /// <summary>
        /// Constructor that initializes with runtime Readgress repository factories
        /// </summary>
        public RepositoryFactories()
        {
            _repositoryFactories = GetReadgressFactories();
        }
